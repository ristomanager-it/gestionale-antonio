...
const SYSTEM_FINALIZZA = [
  ...
  "",
  "IMPIATTAMENTO: compila sempre il blocco 'impiattamento'. E' un DISEGNO tecnico del piatto, non un elenco: chi lo guarda deve capire a colpo d'occhio come viene.",
  "forma_piatto: tondo, fondo, rettangolare, tagliere, bicchiere, monoporzione.",
  "",
  "Per OGNI elemento indica tre cose:",
  "- zona: dove sta nel piatto. SOLO uno di: centro, alto, basso, sinistra, destra, alto-sinistra, alto-destra, basso-sinistra, basso-destra.",
  "- forma: come si presenta visivamente. SOLO uno di questi valori:",
  "    specchio    = salsa stesa sul fondo, larga e sottile",
  "    crema       = crema o purea in massa tonda",
  "    quenelle    = quenelle o cucchiaiata a goccia",
  "    pezzo       = pezzo unico compatto (filetto, trancio, medaglione)",
  "    fetta       = fette o scaloppe sovrapposte",
  "    cubetti     = dadolata, brunoise, pezzetti sparsi",
  "    gocce       = punti di salsa staccati",
  "    filo        = colata sottile a zigzag o riduzione a filo",
  "    polvere     = polvere, terra, crumble sparso",
  "    erbe        = germogli, erbe, micro foglie",
  "    croccante   = cialda, chips, tuile, elemento verticale",
  "    nido        = vegetali o julienne arrotolati a nido",
  "    pasta_lunga = spaghetti, tagliatelle, fettuccine attorcigliati",
  "    pasta_corta = penne, rigatoni, fusilli, paccheri",
  "    risotto     = risotto o cereali stesi all'onda",
  "    zuppa       = zuppa, vellutata, brodo che riempie il fondo",
  "    affettato   = salumi in fette drappeggiate o a rosa",
  "    formaggio   = formaggio a spicchi, tocchetti o scaglie",
  "    insalata    = foglie, misticanza, verdure a volume",
  "    pane        = pane, crostini, bruschette, grissini",
  "- dimensione: piccolo, medio, grande (quanto spazio occupa nel piatto).",
  "",
  "Metti gli elementi nell'ordine di posa: prima le basi e le salse, per ultimo cio' che si rovina.",
  "In note_finali scrivi cosa NON fare e cosa va aggiunto solo al passe'.",
  "",
  "Rispondi ESCLUSIVAMENTE con questo JSON, nessun testo prima o dopo:",
  '{"nome":"","tipo_ricetta":"finita oppure base","categoria_portata":"antipasti|primi|secondi|contorni|dolci|lievitati|salse e basi|finger food","descrizione":"2-3 frasi","attrezzatura":"","resa":{"peso_finale":0.0,"unita_misura":"kg"},"porzioni_previste":0,"peso_porzione_gr":0,"ingredienti":[{"nome":"","quantita":0.0,"unita_misura":"kg","note":""}],"fasi":[{"tipo_fase":"preparazione","descrizione_operativa":"","durata_min":0,"lavoro_umano_min":0,"temperatura":null,"tecnologia":""}],"conservazione":[{"scenario_label":"","shelf_life_giorni":0,"note":""}],"note_chef":"punti critici ed errori da evitare emersi nella conversazione","impiattamento":{"forma_piatto":"tondo","elementi":[{"nome":"","zona":"centro","forma":"specchio|crema|quenelle|pezzo|fetta|cubetti|gocce|filo|polvere|erbe|croccante|nido|pasta_lunga|pasta_corta|risotto|zuppa|affettato|formaggio|insalata|pane","dimensione":"piccolo|medio|grande","quantita":"","note":""}],"sequenza":["primo passo di posa","secondo passo"],"note_finali":"cosa aggiungere solo al passe e cosa evitare"}}',
].join("\n");
...
const SYSTEM_ABBINAMENTO = [
  ...
  "3. Proponi TRE opzioni in bottiglia, in fasce di prezzo diverse, cosi' il cameriere ha sempre una risposta pronta:",
  ...
  "",
  "4. AL CALICE: in questo locale OGNI bottiglia si puo' servire anche al bicchiere. Nella carta trovi accanto a ogni etichetta sia il prezzo bottiglia sia quello al calice (una bottiglia rende 5 calici).",
  "   Nel campo prezzo scrivi SEMPRE il prezzo della bottiglia: al calice ci pensa il locale.",
  "   Metti al_calice true solo sulla proposta che consigli di bere al bicchiere, e scegli un vino con un prezzo al calice sensato: chi prende un bicchiere di solito non vuole spendere come una bottiglia intera.",
  "   Proponi sempre almeno una opzione da bere al calice: molti tavoli non vogliono la bottiglia, e un bicchiere si vende quasi sempre.",
  "   Le voci marcate SOLO AL CALICE esistono unicamente al bicchiere: per quelle il prezzo indicato e' gia' quello del calice.",
  "",
  ...
  '{"profilo":"che vino chiede questo piatto e perche","proposte":[{"vino":"nome ESATTO come in carta","prezzo":0,"categoria":"","fascia":"calice|accessibile|intermedia|importante","al_calice":false,"perche":"una riga da dire al tavolo"}]}',
].join("\n");
