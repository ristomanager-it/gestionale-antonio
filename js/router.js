...
import { initMenu } from "./menu.js?v=5";
...
const routes = {
  ...
  "home-admin": () => import("./views/home-admin.js?v=4"),
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=3"),
  "permessi-operatore": () =>
  ...
  dipendenti: () => import("./views/dipendenti.js?v=5"),
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=3"),
  "crea-ricetta":          () => import("./views/crea-ricetta.js?v=3"),
  "crea-ricetta-avanzata": () => import("./views/crea-ricetta.js?v=3"),
