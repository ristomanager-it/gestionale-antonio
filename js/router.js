...
const routes = {
  ...
  "home-admin": () => import("./views/home-admin.js?v=20"),
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=21"),
  "permessi-operatore": () =>
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  "menu-componibile": () => import("./views/menu-componibile.js?v=5"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=21"),
  "crea-ricetta":          () => import("./views/crea-ricetta.js?v=21"),
  "crea-ricetta-avanzata": () => import("./views/crea-ricetta.js?v=21"),
  ...
  preparazioni: () => import("./views/preparazioni.js?v=30"),
