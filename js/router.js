...
const routes = {
  ...
  "home-admin": () => import("./views/home-admin.js?v=19"),
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=13"),
  "permessi-operatore": () =>
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  "menu-giorno": () => import("./views/menu-giorno.js?v=8"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=13"),
  "crea-ricetta":          () => import("./views/crea-ricetta.js?v=13"),
  "crea-ricetta-avanzata": () => import("./views/crea-ricetta.js?v=13"),
  ...
  "prenotazione-tavolo-form": () => import("./views/prenotazioni/form.js?v=5"),
  "prenotazioni-form": () => import("./views/prenotazioni/form.js?v=5"),
  ...
  "bo-template": () => import("./views/bo/bo-template.js?v=3"),
