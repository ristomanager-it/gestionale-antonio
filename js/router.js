...
const routes = {
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=17"),
  "permessi-operatore": () =>
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=17"),
  "crea-ricetta":          () => import("./views/crea-ricetta.js?v=17"),
  "crea-ricetta-avanzata": () => import("./views/crea-ricetta.js?v=17"),
  ...
  preparazioni: () => import("./views/preparazioni.js?v=11"),
