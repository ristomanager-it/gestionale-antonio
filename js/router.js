...
const routes = {
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=16"),
  "permessi-operatore": () =>
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=16"),
  ...
  "prenotazione-tavolo-form": () => import("./views/prenotazioni/form.js?v=8"),
  "prenotazioni-form": () => import("./views/prenotazioni/form.js?v=8"),
  ...
  "bo-template": () => import("./views/bo/bo-template.js?v=7"),
