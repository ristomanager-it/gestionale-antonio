...
const routes = {
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=14"),
  "permessi-operatore": () =>
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=14"),
  "crea-ricetta":          () => import("./views/crea-ricetta.js?v=14"),
  "crea-ricetta-avanzata": () => import("./views/crea-ricetta.js?v=14"),
  ...
  "bo-template": () => import("./views/bo/bo-template.js?v=6"),
