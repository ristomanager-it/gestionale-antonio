...
const routes = {
  ...
  "ricette-semplici": () =>
    import("./views/crea-ricetta.js?v=19"),
  "permessi-operatore": () =>
...
"scegli-sede": () => import("./views/scegli-sede.js"),
  ...
  creaRicetta: () => import("./views/crea-ricetta.js?v=19"),
  "crea-ricetta":          () => import("./views/crea-ricetta.js?v=19"),
  "crea-ricetta-avanzata": () => import("./views/crea-ricetta.js?v=19"),
  ...
  preparazioni: () => import("./views/preparazioni.js?v=21"),
