...
/* Totali documento come card verticale */
.fattura-totali-card {
  margin-top: 10px;
  padding: 10px;
  border-radius: 12px;
  background: var(--card-bg, #1f2933);
  display: flex;
  flex-direction: column;
  gap: 8px;
}
...
/* Card riga fattura (layout verticale) */
.fatt-riga-card {
  display: flex;
  flex-direction: column;
  gap: 8px;
...
/* Wrapper per righe fattura su mobile */
.fattura-righe-wrapper {
  margin-top: 8px;
}

.fatture-elenco-header,
.fattura-righe-header {
  display: flex;
  justify-content: space-between;
  align-items: center;
  gap: 8px;
